...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::section('Domain');
        yield MenuItem::linkToCrud('Domain', 'fa fa-cogs', Domain::class);

        yield MenuItem::section('History');
        yield MenuItem::linkToCrud('History', 'fa fa-history', History::class);
    }
